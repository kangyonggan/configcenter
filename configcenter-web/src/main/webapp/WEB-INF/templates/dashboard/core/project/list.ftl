...
<div class="page-header">
    <h1>
        ...
        <small class="pull-right">
            <a href="${ctx}/dashboard/core/project/create" class="btn btn-sm btn-inverse" data-toggle="modal" data-target="#myModal"
...
<@c.pagination url="#core/project" param="name=${name}"/>

<script src="${ctx}/static/app/js/dashboard/core/project/list.js"></script>
