...
import com.kangyonggan.app.configcenter.configcenter.biz.service.*;
...
public class ValidateController {
    ...
    @ResponseBody
    public boolean validateProjectCode(@RequestParam("code") String code,
                                    @RequestParam(value = "oldCode", required = false, defaultValue = "") String oldCode) {
        if (code.equals(oldCode)) {
            return true;
        }

        return !projectService.existsProjectCode(code);
    }
