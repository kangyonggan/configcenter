DROP DATABASE IF EXISTS configcenter;
...
VALUES
  ...
  ('CORE', '核心', 'DASHBOARD', 'core', 3, 'menu-icon fa fa-leaf'),
  ('CORE_PROJECT', '项目管理', 'CORE', 'core/project', 0, ''),
  ('CORE_CONFIGURATION', '配置管理', 'CORE', 'core/configuration', 1, ''),
...
VALUES
  ('configcenter', '配置中心', 'project', 0),
  ('page', '页面', 'template', 0),
  ('content', '内容', 'attachment', 0),
  ('local', '本地', 'environment', 0),
  ('dev', '开发', 'environment', 1),
  ('uat', '联调', 'environment', 2),
  ('hd', '灰度', 'environment', 3),
...
6.3 使用本站的任何内容均应注明“来源于配置中心”及署上作者姓名，按法律规定需要支付稿酬的，应当通知本站及作者及支付稿酬，并独立承担一切法律责任。
